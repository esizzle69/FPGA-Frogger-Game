...
vsim -L altera_mf_ver -L altera_mf control
log {/*}
add wave {/*}

force {clk} 	0 0ns, 1 1ns -repeat 2ns
force {reset} 	0 0ns, 1 2ns, 0 4ns
force {done_plotting}  0 0ns, 1 500ns
force {frame_tick}  0 0ns, 1 600ns
force {lose} 0 0ns
force {space} 1 0ns
...
#force {draw_log_1_2} 	0 0ns, 1 157590ns, 0 161290ns
#force {draw_log_1_3} 	0 0ns, 1 161290ns, 0 164990ns
